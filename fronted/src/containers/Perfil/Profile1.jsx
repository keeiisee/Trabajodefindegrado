                ...
                <div className="flex flex-wrap justify-center sm:justify-start space-y-4 sm:space-y-0 sm:space-x-4 mt-6">
                    ...
                    <MediaQuery minWidth={1121}>
                        <button onClick={clickReserva} className="bg-white text-purple-600 font-bold py-2 px-4 rounded focus:outline-none w-full sm:w-auto">
                           ...
                           <img src="https://cdn-icons-png.flaticon.com/512/4615/4615521.png" alt="parque" className="h-5 w-5 inline-block mr-2"/>
                        ...
                        >
                            <img src='https://cdn-icons-png.flaticon.com/512/1373/1373779.png' alt='icono rutinas' className="h-5 w-5 inline-block mr-2" />
                            Rutinas
                        </button>
                        {
                            !editMode &&
